...
export function PrimaryAction({ render, children, compact = false, ...props }: PrimaryActionProps) {
  const className = `${baseClassName} ${compact ? "h-[50px] rounded-10" : "h-14 rounded-14"}`;
